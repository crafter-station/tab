...
const glowClassName =
  "pointer-events-none absolute inset-x-10 -top-10 h-14 bg-[radial-gradient(ellipse_at_center,color-mix(in_srgb,var(--tabb-signal)_14%,transparent),transparent_70%)] opacity-70";
const iconClassName =
