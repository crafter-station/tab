...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("text-balance font-[var(--font-display)] text-xl font-bold leading-tight", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("max-w-[65ch] text-pretty text-base leading-relaxed text-muted-foreground", className)}
    {...props}
  />
))
