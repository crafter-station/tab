  ...
  return (
    <>
      ...
      <div className="mt-6 grid gap-4 [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))]">
        <Card><CardHeader><CardTitle>Monthly usage</CardTitle></CardHeader><CardContent className="flex flex-col gap-4 text-muted-foreground"><p>Plan, quota, and reset dates load from the Tabb API when you are signed in.</p><p className="flex flex-wrap gap-2"><Button asChild><a href="/billing/checkout?plan=pro">Upgrade to Pro</a></Button><Button asChild><a href="/billing/checkout?plan=max">Upgrade to Max</a></Button><Button asChild variant="secondary"><a href="/billing/portal">Manage billing</a></Button></p></CardContent></Card>
