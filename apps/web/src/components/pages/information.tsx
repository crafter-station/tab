    ...
    <>
      ...
      <div className="py-8 sm:py-12">
        ...
        <LegalSection title="Plans and payment">
          <p>Pro and Max each include a one-month free trial for eligible customers. The trial starts when you complete Polar checkout, which requires payment details. Unless you cancel before the trial ends, the selected paid plan begins automatically and Polar charges its monthly price. Polar may prevent repeat trial redemption using normalized email addresses and payment method fingerprints.</p>
