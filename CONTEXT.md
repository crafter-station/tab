...
**Deep Complete**:
A user-initiated Suggestion generated by the cloud path from bounded, redacted context and eligible Personal Memory. Deep Complete is an explicit higher-capability action, not an automatic fallback from local inference.
