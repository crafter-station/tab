...
Double-tapping Option within 400 milliseconds explicitly requests Deep Complete. Any intervening text, shortcut, or navigation input cancels the double-tap sequence so ordinary Option usage does not trigger a request.
